...
const Header = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            const priceInBNB = (
                await routerContract.getAmountsOut(100000, [tokens.dbt.address, tokens.bnb.address])
            )[1];
        ...
        >
            <Container maxWidth="xl">
                ...
                >
                    ...
                    >
                        <Link href="http://discoburntoken.com/" underline="none" target="_blank" height="100%">
                            <Box
                                component="img"
                                alt="logo"
                                    ...
                                    <Stack direction="row" spacing={0.5}>
                                        ...
                                        >
                                            <Box
                                                ...
                                                src={require('../assets/img/dbt.png')}
                                            />
                                            <Stack>
                                                <Typography
                                                    color="textSecondary"
                                                ...
                                                >
                                                    {(() => {
                                                        ...
                                                        return `${formatNumber(fromWei(balance.dbt, 5))} dbt`;
                                                    })()}
                                                </Typography>
                                                <Typography color="textSecondary" variant="caption">
                                                    {(() => {
                                                        if (!balance.dbt || !price.dbt) {
                                                            return (
                                                                <Skeleton
                                                                    sx={{
                                                                        minWidth: (theme) => theme.spacing(10)
                                                        ...
                                                        return `≈ ${formatCurrency(
                                                            fromWei(balance.dbt, 5) * price.dbt,
                                                            activeCurrency
                                                        )}`;
                                                    })()}
                                                </Typography>
