...
const Swap = () => {
    ...
    const { activeSwap, onChangeActiveSwap, onChangeChartView } = useConfig();
    ...
    const buy = async () => {
        ...
        let buyTx = null;
        if (inputToken.isBase) {
            buyTx = swapContract.buy({ value: amount });
        } else {
                ...
                <Grid item xs={12} sm={12}>
                    <Card
                        sx={{
                            ...
                            backgroundImage:
                                'linear-gradient(rgba(46, 2, 128, 0.781) 10%, rgb(231, 71, 159) 75%, #FFA236)',
                            boxShadow:
                                'rgb(0 0 0 / 82%) 0px 2px 10px, rgb(0 0 0 / 40%) 0px 4px 13px -6px, rgb(0 0 0 / 35%) 0px -8px 0px inset',
